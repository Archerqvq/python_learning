...
print(json.dumps(["apple", "bananaa"]))
...
# You can also define the separators, default is(",",":"), which means using a comma and
# a space to separate each object, and a colon and a space to separate keys from values:
# Example
# Use the separators parameter to change th default separator:
print(json.dumps(x, indent=4, separators=(".", "=")))

# Order the Result
# The json.dumps() method has parameters to oder the keys in the result：
# Example
