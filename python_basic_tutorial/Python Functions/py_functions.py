...
# you have to call the function with 2 arguments, not more,
# and not less.
# Example
...
my_function_2("Emil", "Refsnes")


# If you try to call the function with 1 or 3 args, you will get an error:
# Example
...
# Example:
# In the number of args is unknown, add a * before the parameter name:
def my_function_3(*kids):
    print("The youngest child is " + kids[2])


my_function_3("Emil", "Tobias", "Linus")


# my_function_3("Emil", "Linus") # IndexError: tuple index out of range
...
my_function_5(fname="Tobias", lname="Refsnes")
