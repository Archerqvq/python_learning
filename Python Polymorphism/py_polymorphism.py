...
# An example of a Python function that can be used on different obejects
# is the len() function
...
# Dictionary
# For dictionaries len() returns the number of key/value pairs in
# the dictionary:
# Example:
thisdict = {
    "brand": "Ford",
...
# multiple classed with the same method name.
...
# Child classed inherits the properties and methods from the parent class.
# In the example above you can see the Car class is empty, but it
# inherits brand, model, and move() from Vehicle.
# The Boat and Plane classed also inherit brand, model and move()
